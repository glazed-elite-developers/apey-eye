    ...
    _createClass(Model, [{
        ...
        value: function _serialize(id, data) {
            ...
            var obj = {
                ...
                oldObj: _import2['default'].clone(data),
        ...
        value: _asyncToGenerator(function* (serializedObj, data, update) {
            ...
            yield asyncEach(Object.keys(input.properties), function (field, callback) {
                self._processRelatedDataAux(input, data, _ModelRegister2['default'], serializedObj, update, field).then(function (item) {
                    callback();
                });
            });
            return serializedObj;
                        ...
                        if (!ThroughModelClass) {
                            ...
                            if (throughInput) {
                                yield* (function* () {
                                    ...
                                    var sourceField = _import2['default'].findKey(throughInput.properties, function (obj) {
                                        return obj.model === sourceModelName;
                                    });
                                    var targetField = _import2['default'].findKey(throughInput.properties, function (obj) {
