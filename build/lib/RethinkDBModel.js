...
var _RethinkDBAdapter2 = _interopRequireWildcard(_RethinkDBAdapter);

var _import = require('./DefaultProperties');

var DefaultProperties = _interopRequireWildcard(_import);
...
var RethinkDBModel = (function (_Model) {
    ...
    _createClass(RethinkDBModel, [{
        ...
        value: _asyncToGenerator(function* () {
            ...
            this.oldObj = _import4['default'].clone(newObj);
            this.obj = newObj;
        ...
        value: _asyncToGenerator(function* () {
            ...
            if (!obj) {
                ...
                var futureData = _import4['default'].extend(obj, options.data);

                yield ModelClass.valid(futureData);
                var newObj = yield db.updateObject(this.id, options.data, properties);

                this.oldObj = _import4['default'].clone(this.obj);
                this.obj = newObj;
                yield ModelClass.processRelatedData(this, options.data, true);
                yield ModelClass.processOutput(this, properties);
