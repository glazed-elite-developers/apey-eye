...
var _rethink = require('rethinkdbdash');

var _rethink2 = _interopRequireWildcard(_rethink);

var _import = require('./Annotations');

var Annotations = _interopRequireWildcard(_import);

var _DatabaseConfig = require('../config/database.js');

var _DatabaseConfig2 = _interopRequireWildcard(_DatabaseConfig);

var r = _rethink2['default']({
    pool: false
});
...
var RethinkDBAdapter = (function () {
    ...
    _createClass(RethinkDBAdapter, [{
        ...
        key: 'config',
        value: {
            host: _DatabaseConfig2['default'].host,
            port: _DatabaseConfig2['default'].port,
            db: _DatabaseConfig2['default'].database },
        enumerable: true
    }, {
        key: 'createDatabase',
        value: _asyncToGenerator(function* () {
            ...
            try {
                ...
                yield r.dbCreate(_DatabaseConfig2['default'].database).run(c);
            } catch (err) {
