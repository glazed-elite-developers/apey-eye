...
var _BaseClass3 = _interopRequireWildcard(_BaseClass2);

var _import = require('./Annotations');

var Annotations = _interopRequireWildcard(_import);

var _import2 = require('./Exceptions.js');

var Exceptions = _interopRequireWildcard(_import2);

var _import3 = require('./DefaultProperties.js');

var DefaultProperties = _interopRequireWildcard(_import3);

var _import4 = require('./Formatters.js');

var Formatters = _interopRequireWildcard(_import4);

var _RethinkDBModel3 = require('./RethinkDBModel');

var _RethinkDBModel4 = _interopRequireWildcard(_RethinkDBModel3);

var _import5 = require('underscore');

var _import6 = _interopRequireWildcard(_import5);
...
var Resource = (function (_BaseClass) {
    ...
    _createClass(Resource, [{
        key: 'options',
        value: (function (_options3) {
            function options() {
                return _options3.apply(this, arguments);
            }

            options.toString = function () {
                return _options3.toString();
            };
        ...
        key: 'options',
        value: (function (_options2) {
            function options() {
                return _options2.apply(this, arguments);
            }

            options.toString = function () {
                return _options2.toString();
            };
        ...
        value: function _options(pathType) {
            ...
            var ResourceClass = this,
                ...
                collection: {
                    ...
                    formatters: ResourceClass.getFormat() && [ResourceClass.getFormat().getMediaType()] || _import6['default'].reduce(Formatters.FormattersList, function (memo, elem) {
        ...
        value: function _serializeArray(listObj) {
            ...
            var listData = _import6['default'].reduce(listObj, function (memo, elem) {
        ...
        value: function _appendNewModel(resourceName, noBackend) {
            ...
            var ModelRegistered = _ModelRegister2['default'].model(resourceName);
            if (ModelRegistered) {
