...
var _Model2 = require('../lib/Model.js');

var _Model3 = _interopRequireWildcard(_Model2);

var _RethinkDBModel7 = require('../lib/RethinkDBModel.js');

var _RethinkDBModel8 = _interopRequireWildcard(_RethinkDBModel7);

var _Resource51 = require('../lib/Resource.js');

var _Resource52 = _interopRequireWildcard(_Resource51);

var _GenericResource19 = require('../lib/GenericResource.js');

var _GenericResource20 = _interopRequireWildcard(_GenericResource19);
...
var _import4 = require('../lib/Formatters.js');
...
describe('Resources', function () {
    ...
    describe('Resource methods with relations test', function () {
        ...
        before(function (done) {
            ...
            var categoryInput = new _Input2['default']({
                name: { type: 'string', required: true },
                restaurants: {
                    type: 'manyToMany',
                    model: 'restaurant',
    ...
    describe('Generic Resource', function () {
        ...
        it('Automatic creation of model', _asyncToGenerator(function* () {
            ...
            expect(ValidResource.getModel().prototype).to.be.an['instanceof'](_Model3['default']);
